...
model = keras.models.Sequential([
    keras.layers.Dense(50, activation="relu"),     # Layer 1: The first hidden layer
    keras.layers.Dense(10, activation="relu"),     # Layer 2: The second hidden layer
    keras.layers.Dense(1)                          # Layer output: 1 Neuron
])
